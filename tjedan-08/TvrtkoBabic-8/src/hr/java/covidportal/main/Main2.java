...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        List<Zupanija> listaZupanija = unosZupanija();
        List<Simptom> listaSimptomi = unosSimptoma();
        List<Bolest> listaBolesti = unosBolesti(listaSimptomi);
        List<Virus> listaVirusa = unosVirusa(listaSimptomi);
        List<Bolest> listaBolestiIvirusa = unosBolestiIvirusa(listaBolesti, listaVirusa);
        List<Osoba> listaOsoba = unosOsoba(listaZupanija, listaBolesti, listaVirusa);
    ...
    public static List<Osoba> unosOsoba(List<Zupanija> zupanije, List<Bolest> bolesti, List<Virus> virusi) {
        ...
        List<Bolest> bolestiIvirusi = unosBolestiIvirusa(bolesti, virusi);
            ...
            while((linija = reader.readLine()) != null) {
                ...
                if (indexi[0].isEmpty()) {
                    osobeList.add(new Osoba.Builder(id)
                            ...
                            .withBolescu(bolestiIvirusi.get(bolestId - 1))
                            .build());
                } else {
    ...
    /**
     * Služi za unos bolesti ili virusa i odabir simptoma koja ta bolest ili virus ima iz niza prije unešenih simptoma.ž
     * @return povratna vrijednost je objek Bolest koji je unesen
     */
    public static List<Bolest> unosBolestiIvirusa(List<Bolest> bolesti, List<Virus> virusi) {
        List<Bolest> bolestIvirusList = new ArrayList<>();

        bolestIvirusList.addAll(bolesti);
        bolestIvirusList.addAll(virusi);

        return bolestIvirusList;
    }
    ...
    public static List<Zupanija> unosZupanija() {
        ...
        return new ArrayList<>(zupanijaSet);
    }
}