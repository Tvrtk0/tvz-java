...
import hr.java.covidportal.main.Main2;
...
public class PretragaBolestiController implements Initializable {
    ...
    private static final List<Bolest> procitaneBolesti = Main.getProcitaneBolesti();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        stupacSimptomi.setCellValueFactory(new PropertyValueFactory<Bolest, String>("simptomi"));
