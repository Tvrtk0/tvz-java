...
public class Glavna {
    ...
    private static final Integer BR_BOLESTI = 3;
    ...
    public static Osoba unosOsobe(Scanner scanner, Zupanija[] zupanije, Bolest[] bolesti, Osoba[] osobe, int i) {
        ...
        if(i > 0) {
            ...
            return  new Osoba(ime, prezime, starost,
                    zupanije[odabirZupanije-1], bolesti[odabirBolesti-1], kontaktiraneOsobe);
        } else {
            return  new Osoba(ime, prezime, starost,
                    zupanije[odabirZupanije-1], bolesti[odabirBolesti-1], null);
        }
    }
    ...
    public static Bolest unosBolesti(Scanner scanner, Simptom[] simptomi, int i) {
        System.out.print("Unesi naziv bolesti " + (i + 1) + ": ");
