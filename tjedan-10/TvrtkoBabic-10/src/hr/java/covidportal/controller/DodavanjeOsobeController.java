...
public class DodavanjeOsobeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        procitaneBolesti = BazaPodatakaNiti.getSveBolesti();
        procitaneOsobe = BazaPodatakaNiti.getSveOsobe();
    ...
    private void spremiOsobu(String ime, String prezime, LocalDate datumRodjenja, Zupanija odabranaZupanija,
        ...
        if (!izabranKontakt.isEmpty()) {
            ...
            for (long id : izabranKontakt) {
                izabraniKontakti.add(BazaPodatakaNiti.getOsobaById(id));
            }

            BazaPodatakaNiti.spremiNovuOsobu(new Osoba.Builder(null)
                    .withIme(ime)
                    .withPrezime(prezime)
