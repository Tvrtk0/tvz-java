...
public class Glavna {
    ...
    public static void main(String[] args) {
        ...
        // Klinika
        List<Bolest> listaBolesti  = new ArrayList<>(setBolesti);
        ...
        klinika = klinikaSortiranjeVirusa(klinika);
    ...
    public static void pretragaPoPrezimenu(Scanner scanner, List<Osoba> listaOsoba) {
        ...
        //osoba1.ifPresentOrElse(osoba -> System.out.println(), () -> System.out.println(""));
        if (osoba1.isPresent()) {
     ...
     * @return povratna vrijednsot je sortirana klinika
     */
    public static KlinikaZaInfektivneBolesti<Virus, Osoba> klinikaSortiranjeVirusa
